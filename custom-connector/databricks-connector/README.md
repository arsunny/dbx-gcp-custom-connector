...
This custom connector extracts metadata from Databricks Unity Catalog into [Dataplex Universal Catalog](https://cloud.google.com/dataplex/docs/introduction).
...
|workspace_url|Databricks workspace url to connect to||REQUIRED|
|http_path|Databricks sql engine to use for querying unity catalog||REQUIRED|
|password_secret|Google Secret Manager ID holding the password for the Databricks user. Format: secret:projects/{project-number}/secrets/{secret-name}||REQUIRED|
|metastore|Databricks metastore to connect to||REQUIRED|
...
--workspace_url dbc-xxxxxxxx-xxxx.cloud.databricks.com \
--password_secret secret:projects/gcp-project-number/secrets/databricks-pat \
...
Entry Type|**databricks-metastore**&nbsp;&nbsp;**databricks-catalog**&nbsp;&nbsp;**databricks-schema**&nbsp;&nbsp;**databricks-table**&nbsp;&nbsp;**databricks-view**&nbsp;&nbsp;**databricks-models**&nbsp;&nbsp;**databricks-volumes**&nbsp;&nbsp;**databricks-functions**|  
Aspect Type|**databricks-metastore**&nbsp;&nbsp;**databricks-catalog**&nbsp;&nbsp;**databricks-schema**&nbsp;&nbsp;**databricks-table**&nbsp;&nbsp;**databricks-view**&nbsp;&nbsp;**databricks-models**&nbsp;&nbsp;**databricks-volumes**&nbsp;&nbsp;**databricks-functions**| 
